    ...
    <div className="mt-3 relative min-h-[500px] w-full">
      {projectsWithRows.map(({ project, row }) => {
        ...
        return (
          ...
          >
            <div 
              className={`absolute h-10 rounded flex items-center px-3 cursor-pointer overflow-hidden whitespace-nowrap text-ellipsis shadow-md transition-all duration-300 ${statusColor} text-white`}
              style={{
                left: `${startPosition}%`,
                width: `${width}%`,
