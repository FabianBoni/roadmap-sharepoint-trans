...
const ApiDocsPage: React.FC = () => {
        ...
        <DocsLayout>
            <div className="max-w-4xl mx-auto">
                ...
                <div className="prose prose-invert max-w-none">
                    <p>
                        Die Roadmap JSD-Anwendung bietet eine umfassende REST-API, mit der Sie programmatisch auf alle Funktionen der Anwendung zugreifen können. Diese Dokumentation beschreibt die verfügbaren Endpunkte, Parameter und Antwortformate.
                    </p>

                    <h2 className="text-2xl font-bold mt-8 mb-4">API-Übersicht</h2>

                    <p>
                        Die API ist in mehrere Hauptbereiche unterteilt:
                    </p>

                    <ul className="list-disc pl-6 my-4">
                        <li><strong>Projekte</strong>: Verwaltung von Roadmap-Projekten</li>
                        <li><strong>Kategorien</strong>: Verwaltung von Projektkategorien</li>
                        <li><strong>Feldtypen</strong>: Verwaltung von benutzerdefinierten Feldtypen</li>
                        <li><strong>Authentifizierung</strong>: Benutzeranmeldung und -verwaltung</li>
                    </ul>

                    <h2 className="text-2xl font-bold mt-8 mb-4">Authentifizierung</h2>

                    <p>
                        Die meisten API-Endpunkte erfordern eine Authentifizierung. In der aktuellen Version wird eine einfache Authentifizierung verwendet, bei der Sie sich über den <code>/api/auth/login</code>-Endpunkt anmelden müssen.
                    </p>

                    <h3 className="text-xl font-bold mt-6 mb-3">Anmeldung</h3>

                    <pre className="bg-gray-800 p-4 rounded-md overflow-x-auto">
                        <code>POST /api/auth/login</code>
                    </pre>

                    <p className="mt-4"><strong>Anforderungskörper</strong>:</p>
  ...
  "password": "admin123"
                    ...
                    <p className="mt-4"><strong>Erfolgreiche Antwort</strong>:</p>
  ...
  "user": {
    ...
    "role": "ADMIN"
                    ...
                    <p>
                        Die Kategorien-API ermöglicht es Ihnen, Projektkategorien zu verwalten.
                    </p>
                    ...
                    <p>
                        Die Feldtypen-API ermöglicht es Ihnen, benutzerdefinierte Feldtypen zu verwalten.
                    </p>
