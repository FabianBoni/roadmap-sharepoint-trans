    ...
    <DocsLayout>
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-invert max-w-none">
          <p>
            Das Admin-Dashboard ist die zentrale Anlaufstelle für die Verwaltung aller Aspekte der
            Roadmap JSD-Anwendung. Diese Anleitung führt Sie durch die verschiedenen Funktionen und
            Möglichkeiten, die im Dashboard verfügbar sind.
          </p>

          <h2 className="text-2xl font-bold mt-8 mb-4">Zugriff auf das Admin-Dashboard</h2>

          <p>
            Um auf das Admin-Dashboard zuzugreifen, navigieren Sie zu <code>/admin</code> in Ihrem
            Browser. Sie müssen sich mit Admin-Anmeldedaten anmelden:
          </p>
          ...
          <div className="bg-gray-800 p-4 rounded-md my-4">
            ...
            <p className="mt-2">
              Ändern Sie das Standard-Admin-Passwort nach der ersten Anmeldung, um die Sicherheit
          ...
          <p>Das Admin-Dashboard ist in drei Hauptbereiche unterteilt:</p>

          <ol className="list-decimal pl-6 my-4">
            <li>
              <strong>Projekte</strong>: Verwalten Sie alle Projekte im System
            </li>
            <li>
              <strong>Kategorien</strong>: Verwalten Sie Projektkategorien
            </li>
            <li>
              <strong>Feldtypen</strong>: Verwalten Sie benutzerdefinierte Feldtypen
            </li>
          </ol>

          <p>
            Sie können zwischen diesen Bereichen über die Registerkarten am oberen Rand des
            Dashboards wechseln.
          </p>
          ...
          <p>
            Die Registerkarte &quot;Projekte&quot; zeigt eine Tabelle aller Projekte im System,
            einschließlich:
          </p>
          ...
          <p>Um ein neues Projekt zu erstellen:</p>
          ...
          <ol className="list-decimal pl-6 my-4">
            ...
            <li>
              Füllen Sie das Projektformular mit den erforderlichen Informationen aus:
          ...
          <p>Um ein bestehendes Projekt zu bearbeiten:</p>

          <ol className="list-decimal pl-6 my-4">
            <li>Suchen Sie das Projekt in der Tabelle</li>
            <li>
              Klicken Sie auf die Schaltfläche &quot;Bearbeiten&quot; in der Spalte
              &quot;Aktionen&quot;
            </li>
          ...
          <p>Um ein Projekt zu löschen:</p>

          <ol className="list-decimal pl-6 my-4">
            <li>Suchen Sie das Projekt in der Tabelle</li>
            <li>
              Klicken Sie auf die Schaltfläche &quot;Löschen&quot; in der Spalte
              &quot;Aktionen&quot;
            </li>
            <li>
              Bestätigen Sie die Löschung, indem Sie auf &quot;Bestätigen&quot; klicken, wenn Sie
          ...
          <div className="bg-gray-800 p-4 rounded-md my-4">
            ...
            <p className="mt-2">
              Das Löschen eines Projekts ist endgültig und kann nicht rückgängig gemacht werden.
              Stellen Sie sicher, dass Sie das richtige Projekt löschen.
            </p>
          </div>
          ...
          <p>
            Kategorien helfen dabei, Projekte in logische Gruppen zu organisieren. Jede Kategorie
            hat einen Namen, eine Farbe und ein Symbol.
          </p>

          <h3 className="text-xl font-bold mt-6 mb-3">Eine neue Kategorie erstellen</h3>

          <p>Um eine neue Kategorie zu erstellen:</p>

          <ol className="list-decimal pl-6 my-4">
            <li>Wechseln Sie zur Registerkarte &quot;Kategorien&quot;</li>
            <li>Klicken Sie auf die Schaltfläche &quot;Neue Kategorie&quot;</li>
            <li>
              Füllen Sie das Kategorieformular aus:
              <ul className="list-disc pl-6 my-2">
                <li>Name</li>
          ...
          <p>Um eine bestehende Kategorie zu bearbeiten:</p>
          ...
          <p>Um eine Kategorie zu löschen:</p>
          ...
          <div className="bg-gray-800 p-4 rounded-md my-4">
            <p className="font-bold">Hinweis</p>
            <p className="mt-2">
              Das Löschen einer Kategorie löscht nicht die zugehörigen Projekte, aber diese Projekte
              haben dann keine gültige Kategorie mehr zugewiesen.
            </p>
          </div>
          ...
          <p>
            Mit Feldtypen können Sie benutzerdefinierte Felder für Projekte definieren, wie
            Technologien, Prozesse, Dienste oder Datentypen.
          </p>

          <h3 className="text-xl font-bold mt-6 mb-3">Einen neuen Feldtyp erstellen</h3>

          <p>Um einen neuen Feldtyp zu erstellen:</p>

          <ol className="list-decimal pl-6 my-4">
            <li>Wechseln Sie zur Registerkarte &quot;Feldtypen&quot;</li>
            <li>Klicken Sie auf die Schaltfläche &quot;Neues Feld&quot;</li>
            <li>
              Füllen Sie das Feldtyp-Formular aus:
              <ul className="list-disc pl-6 my-2">
                <li>Name</li>
          ...
          <p>Um einen bestehenden Feldtyp zu bearbeiten:</p>
          ...
          <p>Um einen Feldtyp zu löschen:</p>
          ...
          <div className="bg-gray-800 p-4 rounded-md my-4">
            <p className="font-bold">Hinweis</p>
            <p className="mt-2">
              Das Löschen eines Feldtyps wirkt sich auf alle Projekte aus, die diesen Feldtyp
              verwenden. Die entsprechenden Daten gehen verloren.
            </p>
          </div>

          <h2 className="text-2xl font-bold mt-8 mb-4">
            Tipps für die effektive Nutzung des Admin-Dashboards
          </h2>
          ...
          <ul className="list-disc pl-6 my-4">
            <li>
              Verwenden Sie aussagekräftige Projekttitel, die den Zweck des Projekts klar
              kommunizieren
            </li>
            <li>
              Weisen Sie Projekte konsistent Kategorien zu, um eine klare visuelle Unterscheidung
              auf der Roadmap zu ermöglichen
            </li>
          ...
          <ul className="list-disc pl-6 my-4">
            <li>
              Halten Sie die Anzahl der Kategorien überschaubar (idealerweise nicht mehr als 5-7)
            </li>
            <li>
              Verwenden Sie kontrastierende Farben für verschiedene Kategorien, um sie leicht
          ...
          <ul className="list-disc pl-6 my-4">
            ...
            <li>
              Fügen Sie aussagekräftige Beschreibungen hinzu, um Benutzern zu helfen, den Zweck des
              Feldtyps zu verstehen
            </li>
          </ul>
          ...
          <div className="bg-gray-800 p-4 rounded-md my-4">
            ...
            <ul className="list-disc pl-6 mt-2">
              ...
              <li>
                Stellen Sie sicher, dass Farben im Hex-Format eingegeben werden (z.B. #4299E1)
              </li>
            </ul>
          </div>
          ...
          <ul className="list-disc pl-6 my-4">
            <li>
              Stellen Sie sicher, dass die Roadmap übersichtlich bleibt und nicht überladen wird
            </li>
            <li>
              Verwenden Sie konsistente Benennungskonventionen für Projekte, Kategorien und
              Feldtypen
            </li>
          ...
          <p>Es wird empfohlen, regelmäßige Backups der Datenbank durchzuführen:</p>
...
mysqldump -u benutzername -p roadmap_jsd > backup_$(date +%Y%m%d).sql`}</code>
          ...
          <p>Um die Anwendung auf die neueste Version zu aktualisieren:</p>

          <ol className="list-decimal pl-6 my-4">
            <li>Sichern Sie Ihre Datenbank</li>
            <li>
              Ziehen Sie die neuesten Änderungen aus dem Repository:
            ...
            <li>
              ...
              <pre className="bg-gray-800 p-4 rounded-md overflow-x-auto mt-2">
                <code>yarn prisma migrate deploy</code>
              </pre>
            </li>
            <li>
              Erstellen Sie einen neuen Build und starten Sie die Anwendung neu:
              <pre className="bg-gray-800 p-4 rounded-md overflow-x-auto mt-2">
          ...
          <div className="space-y-4 mt-4">
            <div>
              ...
              <p>
                Derzeit muss das Admin-Passwort direkt in der Datenbank zurückgesetzt werden. In
                einer zukünftigen Version wird eine Funktion zum Zurücksetzen des Passworts über die
            ...
            <div>
              ...
              <p>
                In der aktuellen Version gibt es nur einen Admin-Benutzer. Die Unterstützung für
                mehrere Admin-Benutzer ist für zukünftige Versionen geplant.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Die Roadmap-Ansicht wird automatisch basierend auf den erstellten Projekten und
                Kategorien generiert. Sie können die Darstellung anpassen, indem Sie Kategorien
                bearbeiten und deren Farben ändern.
              </p>
            </div>

            <div>
              <h3 className="text-lg font-bold">
                Gibt es eine Möglichkeit, Projekte zu archivieren statt zu löschen?
              </h3>
              <p>
                In der aktuellen Version können Projekte nur gelöscht, nicht archiviert werden. Die
                Archivierungsfunktion ist für zukünftige Versionen geplant.
              </p>
            </div>
          </div>
          ...
          <ul className="list-disc pl-6 my-4">
            <li>
              ...
              - Für Entwickler, die programmatisch mit dem System interagieren möchten
            </li>
            <li>
              <Link href="/docs/funktionen" className="text-blue-400 hover:text-blue-300">
                Funktionen
              </Link>{' '}
              - Detaillierte Beschreibungen der Hauptfunktionen
            </li>
            <li>
              <Link
              ...
              - Anleitung zur Installation und Einrichtung des Systems
            </li>
          </ul>
          ...
          <p>
            Wenn Sie weitere Unterstützung benötigen oder Fragen zur Administration von Roadmap JSD
            haben, wenden Sie sich an:
          </p>

          <ul className="list-disc pl-6 my-4">
            <li>
              <strong>E-Mail</strong>: support@jsd.bs.ch
            </li>
            <li>
              <strong>Dokumentation</strong>: Überprüfen Sie die neueste Version dieser
              Dokumentation
            </li>
            <li>
              <strong>GitHub</strong>: Besuchen Sie das{' '}
              <a
                href="https://github.com/FabianBoni/roadmap-jsd"
                className="text-blue-400 hover:text-blue-300"
                target="_blank"
