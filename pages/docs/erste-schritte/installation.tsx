    ...
    <DocsLayout>
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-invert max-w-none">
          <p>
            Diese Anleitung führt Sie durch den Prozess der Einrichtung von Roadmap JSD in Ihrer
            lokalen Umgebung.
          </p>

          <h2 className="text-2xl font-bold mt-8 mb-4">Voraussetzungen</h2>

          <p>Bevor Sie beginnen, stellen Sie sicher, dass Sie Folgendes installiert haben:</p>

          <ul className="list-disc pl-6 my-4">
            <li>Node.js (v14 oder höher)</li>
            <li>
              Yarn 1.22.22 (bei Bedarf mit <code>corepack enable</code> aktivieren)
            </li>
            <li>Git</li>
          </ul>
          ...
          <p>Klonen Sie das Repository mit folgendem Befehl:</p>

          <pre className="bg-gray-800 p-4 rounded-md overflow-x-auto">
            <code>git clone https://github.com/FabianBoni/roadmap-jsd.git cd roadmap-jsd</code>
          </pre>

          <h2 className="text-2xl font-bold mt-8 mb-4">Schritt 2: Abhängigkeiten installieren</h2>

          <p>Installieren Sie die erforderlichen Abhängigkeiten:</p>
          ...
          <p>
            Roadmap JSD verwendet Prisma mit einer Datenbank. Sie müssen Ihre Datenbankverbindung
            einrichten:
          </p>
          ...
          <ol className="list-decimal pl-6 my-4">
            ...
            <li>
              Fügen Sie Ihren Datenbankverbindungsstring hinzu:
            ...
            <li>
              Führen Sie Prisma-Migrationen aus:
              <pre className="bg-gray-800 p-4 rounded-md overflow-x-auto mt-2">
          ...
          <p className="mt-4">
            ...
            <a href="http://localhost:3000" className="text-blue-400 hover:text-blue-300">
              http://localhost:3000
            </a>{' '}
            laufen.
          </p>
          ...
          <p>Um auf das Admin-Dashboard zuzugreifen:</p>

          <ol className="list-decimal pl-6 my-4">
            <li>
              Navigieren Sie zu{' '}
              <a href="http://localhost:3000/admin" className="text-blue-400 hover:text-blue-300">
                http://localhost:3000/admin
              </a>
            </li>
            <li>
              Melden Sie sich mit den Standard-Admin-Anmeldedaten an:
          ...
          <p>Nach der Installation können Sie:</p>
          ...
          <div className="bg-gray-800 p-4 rounded-md my-4">
            <p className="font-bold">
              Fehler: &quot;Prisma Client konnte nicht mit der Datenbank verbinden&quot;
            </p>
            <p className="mt-2">
              Lösung: Überprüfen Sie Ihre Datenbankverbindung und stellen Sie sicher, dass die
              Datenbank läuft.
            </p>
          </div>
          ...
          <div className="bg-gray-800 p-4 rounded-md my-4">
            ...
            <p className="mt-2">
              Lösung: Führen Sie <code>yarn install --frozen-lockfile</code> aus, um
              sicherzustellen, dass alle Abhängigkeiten installiert sind.
            </p>
          </div>
          ...
          <p className="mt-4">
            Für detailliertere Informationen zur Bereitstellung besuchen Sie die{' '}
            <a
            ...
            >
              Next.js-Bereitstellungsdokumentation
            </a>
            .
          </p>
        </div>
